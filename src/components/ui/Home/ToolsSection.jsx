    ...
    return(
        <div className="mt-4 mb-28 flex flex-col gap-8">
            ...
            <div className="flex flex-col border-2 border-background gap-8 rounded-lg px-8 py-8">
                ...
                <div className="grid grid-cols-1 gap-y-8 sm:grid-cols-2 xl:grid-cols-3">
                    <div className="flex gap-4">
                        <img loading="lazy" className="w-12 2xl:w-14" src="./assets/html_logo.png" alt="html logo" />
                    ...
                    <div className="flex gap-4">
                        <img loading="lazy" className="w-12 2xl:w-14" src="./assets/css_logo.png" alt="css logo" />
                        <div className="flex flex-col">
                    ...
                    <div className="flex gap-4">
                        <img loading="lazy" className="w-12 2xl:w-14" src="./assets/javascript_logo.png" alt="javascript logo" />
                        <div className="flex flex-col">
                    ...
                    <div className="flex gap-4">
                        <img loading="lazy" className="w-12 2xl:w-14" src="./assets/react_logo.png" alt="react logo" />
                        <div className="flex flex-col">
                    ...
                    <div className="flex gap-4">
                        <img loading="lazy" className="w-12 2xl:w-14" src="./assets/tailwind_logo.png" alt="tailwind logo" />
                        <div className="flex flex-col">
                    ...
                    <div className="flex gap-4">
                        <img loading="lazy" className="w-12 2xl:w-14" src="./assets/redux_logo.png" alt="redux logo" />
                        <div className="flex flex-col">
            ...
            <div className="flex flex-col border-2 border-background gap-8 rounded-lg px-8 py-8">
                ...
                <div className="grid grid-cols-1 gap-y-8 sm:grid-cols-2 xl:grid-cols-3">
                    <div className="flex gap-4">
                        <img loading="lazy" className="w-12 2xl:w-14" src="./assets/sql_logo.png" alt="sql logo" />
                        <div className="flex flex-col">
                    ...
                    <div className="flex gap-4">
                        <img loading="lazy" className="w-12 2xl:w-14" src="./assets/postgres_logo.png" alt="postgres logo" />
                        <div className="flex flex-col">
                    ...
                    <div className="flex gap-4">
                        <img loading="lazy" className="w-12 2xl:w-14" src="./assets/express_logo.png" alt="express logo" />
                        <div className="flex flex-col">
                    ...
                    <div className="flex gap-4">
                        <img loading="lazy" className="w-12 2xl:w-14" src="./assets/node_logo.png" alt="node logo" />
                        <div className="flex flex-col">
                    ...
                    <div className="flex gap-4">
                        <img loading="lazy" className="w-12 2xl:w-14" src="./assets/aws_logo.png" alt="aws logo" />
                        <div className="flex flex-col">
                    ...
                    <div className="flex gap-4">
                        <img loading="lazy" className="w-12 2xl:w-14" src="./assets/php_logo.png" alt="php logo" />
                        <div className="flex flex-col">
            ...
            <div className="flex flex-col border-2 border-background gap-8 rounded-lg px-8 py-8">
                ...
                <div className="grid grid-cols-1 gap-y-8 sm:grid-cols-2 xl:grid-cols-3">
                    <div className="flex gap-4">
                        <img loading="lazy" className="w-12 2xl:w-14" src="./assets/git_logo.png" alt="git logo" />
                        <div className="flex flex-col">
                    ...
                    <div className="flex gap-4">
                        <img loading="lazy" className="w-12 2xl:w-14" src="./assets/postman_logo.png" alt="postman logo" />
                        <div className="flex flex-col">
                    ...
                    <div className="flex gap-4">
                        <img loading="lazy" className="w-12 2xl:w-14" src="./assets/vim_logo.png" alt="vim logo" />
                        <div className="flex flex-col">
            ...
            <div className="flex flex-col border-2 border-background gap-8 rounded-lg px-8 py-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-8">
                    <div className="flex gap-4">
                        <img loading="lazy" className="w-12 2xl:w-14" src="./assets/python_logo.png" alt="python logo" />
                        <div className="flex flex-col">
                    ...
                    <div className="flex gap-4">
                        <img loading="lazy" className="w-12 2xl:w-14" src="./assets/java_logo.png" alt="java logo" />
                        <div className="flex flex-col">
