...
const LeetcodeProject = () => {
    return (
        <div className="bg-gray-400 w-screen h-screen flex justify-center shadow-xl">
            <div className="overflow-y-scroll sm:w-5/6 md:w-4/5 lg:w-3/5 xl:w-2/5 2xl:w-2/6 my-4 border shadow-lg rounded-xl bg-white p-6 flex flex-col">
                ...
                <ul className="list-disc pl-3 pt-8">
                    <li className="text-primary font-poppins text-sm 2xl:text-lg">A bunch of Data Structures and Algorithm problems that I solved for fun.</li>
                </ul>
            </div>
        </div>
    )
