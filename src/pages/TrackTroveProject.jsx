        ...
        <div className="bg-orange-200 w-screen h-screen flex justify-center shadow-xl">
            <div className="overflow-y-auto sm:w-5/6 md:w-4/5 lg:w-3/5 xl:w-2/5 2xl:w-2/6 my-4 border shadow-lg rounded-xl bg-white p-6 flex flex-col">
                ...
                <div className="flex justify-around py-6">
                    ...
                    <a href="https://www.youtube.com/watch?v=ZQzyLCHW30Q&ab_channel=Fynn" target="_blank" className="text-sm px-2 py-1 border rounded-xl border-opacity-50 shadow-md transition-all duration-100 hover:scale-105">View Demo</a>
                </div>
